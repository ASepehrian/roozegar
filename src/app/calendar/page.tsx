...
import { monthNamesFor } from "@/lib/calendar";
...
export default function CalendarIndex(){
  ...
  <section className="seo-grid">{monthNamesFor("persian").map((m,i)=><article className="seo-card" key={m}><h2><Link className="seo-link" href={`/calendar/1405/${i+1}`}>{m} ۱۴۰۵</Link></h2><p>تقویم {m} سال ۱۴۰۵، همراه با دسترسی به تاریخ و مناسبت‌های روز.</p></article>)}</section>
